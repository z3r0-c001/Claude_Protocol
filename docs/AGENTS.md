...
> **Note:** Agent suggestions are based on pattern matching and may not always be optimal for your specific situation. Use your judgment when accepting agent recommendations.

> **Caveat:** Agents invoke Claude subprocesses that inherit the same limitations as the main Claude instance. They can make mistakes, suggest incorrect code, or misunderstand requirements. Always review agent output.
...
**Purpose:** Analyze project structure, detect languages/frameworks, and identify patterns.

**Location:** `.claude/agents/domain/codebase-analyzer.md`

**Invocation:**
- Via `/proto-init` command
...
**Purpose:** Generate project-specific Claude artifacts including CLAUDE.md, agents, skills, and commands.

**Location:** `.claude/agents/domain/protocol-generator.md`
...
**Purpose:** UI/UX design, component architecture, and frontend implementation.

**Location:** `.claude/agents/domain/frontend-designer.md`

**Invocation:**
- Automatically when editing frontend files (*.tsx, *.jsx, *.vue, *.svelte)
- Via frontend-design skill
- Manual invocation for UI work
...
**Purpose:** Research UI patterns, component libraries, and frontend best practices.

**Location:** `.claude/agents/domain/ui-researcher.md`

**Invocation:**
- Via frontend-designer agent
- Manual invocation for research
...
**Purpose:** Fetch and apply protocol updates from GitHub with interactive approval.

**Location:** `.claude/agents/domain/protocol-updater.md`

**Invocation:**
- Via `/proto-update` command
- Startup notification if updates available

**Features:**
- Version comparison with manifest
...
**Purpose:** Smart analysis and optimization suggestions for protocol installation.

**Location:** `.claude/agents/domain/protocol-analyzer.md`

**Invocation:**
- Via `/proto-update --analyze` command
- For protocol health assessment
...
**Purpose:** Facilitate design refinement through Socratic questioning before implementation.

**Location:** `.claude/agents/workflow/brainstormer.md`

**Invocation:**
- Keywords: "I want to build", "help me plan", "brainstorm"
- Before non-trivial feature implementations
- Via brainstormer skill

**Inspiration:** This agent's Socratic questioning approach draws inspiration from [obra/superpowers](https://github.com/obra/superpowers).
...
| Frontend files (*.tsx, etc.) | frontend-designer |
| "I want to build..." prompts | brainstormer |
| `/proto-update` command | protocol-updater, protocol-analyzer |

...
> **Note:** Configuration changes take effect after restarting Claude Code. Always validate JSON files after editing.

> **Important:** The permissive permissions template is optimized for development productivity but allows broad file system access. For security-sensitive environments, consider the restricted template or custom permissions.

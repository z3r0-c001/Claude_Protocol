 ...
 */
import { AUTO_SAVE_CATEGORIES, PERMISSION_REQUIRED_CATEGORIES, READ_ONLY_CATEGORIES } from "../types/memory.js";
...
function formatPermissionRequest(category, key, value, reason) {
    const lines = [
